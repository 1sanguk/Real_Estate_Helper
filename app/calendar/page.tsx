  ...
  return (
    <main className="min-h-screen bg-background px-8 py-9 text-foreground">
      <div className="mx-auto max-w-6xl space-y-6">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4"><div><div className="flex items-center gap-2"><CalendarDays className="size-7 text-primary" /><h1 className="text-3xl font-black">지원 일정 캘린더</h1></div><p className="mt-2 text-sm text-muted-foreground">LH·SH·HUG의 접수 기간이 확인된 진행 중 공식 공고 일정입니다.</p></div><Link href="/saved" className="text-sm font-bold text-primary">관심 공고 관리</Link></div>
