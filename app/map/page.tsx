...
export default function ListingMapPage() {
  ...
  return <main className="min-h-screen bg-background px-8 py-9 text-foreground"><div className="mx-auto max-w-6xl space-y-6">
    ...
    {!error && visible.length > 0 && <Suspense fallback={<div className="grid h-[62vh] min-h-[480px] place-items-center rounded-2xl border bg-white"><p>지도를 불러오고 있습니다…</p></div>}><ListingMapProvider listings={visible} focusedRegion={region} onListingSelect={openListing} /></Suspense>}
